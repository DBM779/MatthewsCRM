-- Matthews CRM PostgreSQL Schema
...
CREATE TABLE IF NOT EXISTS accounts (
    ...
    revenue NUMERIC,
    ebitda NUMERIC,
    port_status TEXT DEFAULT 'Active',
...
CREATE TABLE IF NOT EXISTS deal_checklist (
    ...
    UNIQUE(deal_id, stage, item_index)
);
...
CREATE TABLE IF NOT EXISTS connections (
    id TEXT PRIMARY KEY,
    from_contact_id TEXT REFERENCES contacts(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS referrals (
    id TEXT PRIMARY KEY,
    from_id TEXT REFERENCES contacts(id) ON DELETE SET NULL,
    to_id TEXT REFERENCES contacts(id) ON DELETE SET NULL,
    type TEXT,
